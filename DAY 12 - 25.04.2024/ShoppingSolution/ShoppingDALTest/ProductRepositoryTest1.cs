...
namespace ShoppingDALTest
{
    public class ProductRepositoryTest1
    {
        ...
        public void AddExceptionTest()
        {
            ...
            //Action
            var exception = Assert.Throws<NoProductWithGivenIDException>(() => repository.Add(product));
            //Assert
        ...
        public void DeleteExceptionTest()
        {
            ...
            var result = repository.Add(product);
            //Action
            var exception = Assert.Throws<NoProductWithGivenIDException>(() => repository.Delete(102));
            //Assert
        ...
        public void UpdateExceptionTest()
        {
            ...
            P2.Id = 102;
            //Action
            var exception = Assert.Throws<NoProductWithGivenIDException>(() => repository.Update(P2));
            //Assert
        ...
        public void GetExceptionTest()
        {
            ...
            var result = repository.Add(product);
            //Action
            var exception = Assert.Throws<NoProductWithGivenIDException>(() => repository.GetByKey(102));
            //Assert
