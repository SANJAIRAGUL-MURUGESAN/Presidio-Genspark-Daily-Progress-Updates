...
function validateInputs(){
    ...
    if(reservationidVal === ''){
        success=false;
        setError(reservationid,'Reservation ID is required')
    }else if(reservationidVal == 0){
        success=false;
        setError(reservationid,'Reservation ID cannot be equal to zero')
    }else if(reservationidVal < 0){
        success=false;
        setError(reservationid,'Reservation ID cannot be less to zero');
    }else{
