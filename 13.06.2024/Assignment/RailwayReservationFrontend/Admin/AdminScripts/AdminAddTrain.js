...
function validateInputs(){
    ...
    if(trainnameVal===''){
        ...
        success = false;
        setError(trainname,'Train Name must be less than 3 characters long')
    }
    else{
    ...
    if(startingpointVal===''){
        ...
        success = false;
        setError(startingpoint,'Starting Point must be less than 3 characters long')
    }
    else{
    ...
    if(endingpointVal===''){
        ...
        success = false;
        setError(endingpoint,'Ending Point must be less than 3 characters long')
    }
    else{
    ...
    else if(trainstatusVal.length.length<3){
        success = false;
        setError(trainstatus,'Train Status must be less than 3 characters long')
    }
    else{
