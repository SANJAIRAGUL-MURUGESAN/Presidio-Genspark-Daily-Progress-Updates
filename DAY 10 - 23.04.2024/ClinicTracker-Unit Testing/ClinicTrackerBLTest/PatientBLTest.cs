...
namespace ClinicTrackerBLTest
{
    public class PatientBLTest
    {
        ...
        public void Setup()
        {
            ...
            Patient patient = new Patient() { Name = "sanjai",MajorDisease = "Sugar" };
        ...
        {
            var patient = patientService.ChangePatientName(1, "Ragul");
            Assert.AreEqual(1, patient.Id);
        }
        [Test]
        public void ChangePatientnameFail()
        {
            var patient = patientService.ChangePatientName(2, "Ragul");
